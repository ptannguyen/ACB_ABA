...
WebUI.comment("TC_06_LOGIN_ORANGE_HRM_SUCCESSFULLY")
...
WebUICommon.inputDataToTestObject(findTestObject('Object Repository/Page_OrangeHRM/Login/txtUsername'), GlobalVariable.GUserNameOrangeHRM, GlobalVariable.GTimeOut10)
...
WebUI.comment("Step 4: 01 - Verify Admin section is visible ")
WebUICommon.verifyObjectVisible(findTestObject('Object Repository/Page_OrangeHRM/UserManagement/aAdmin'), GlobalVariable.GTimeOut10)

WebUI.comment("Step 4: 02 - Verify Dashboard section is visible ")
WebUICommon.verifyObjectVisible(findTestObject('Object Repository/Page_OrangeHRM/UserManagement/h6Dashboard'), GlobalVariable.GTimeOut10)
